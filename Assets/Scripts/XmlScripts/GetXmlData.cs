...
public class GetXmlData
{
	...
	public CostumeBasesSettings GetCostumeBasesSettings ()
	{
		XmlSerializer x = new XmlSerializer (typeof(CostumeBasesSettings));
	...
	public CostumeBasesSettingsCostumeBase GetCostumeBasesSettingsCostumeBase (string index)
	{
		var costumeBase = costumeBasesSettings.Items.Where (
			item => item.Index.Equals (index)).FirstOrDefault ();
		return costumeBase;
	}
